...
def main():
    ...
    first_asteroid = Asteroid(300, 300, ASTEROID_MIN_RADIUS)
    second_asteroid = Asteroid(800, 300, ASTEROID_MIN_RADIUS)

    first_asteroid.velocity = pygame.Vector2(200, 0)
    second_asteroid.velocity = pygame.Vector2(-200, 0)
